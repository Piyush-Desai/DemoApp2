...
import 'package:demoapp/UI/commons/InternationalPhoneInput/utils/phone_number/phone_number_util.dart';
...
import 'package:demoapp/UI/commons/InternationalPhoneInput/providers/country_provider.dart';
import 'package:demoapp/UI/commons/InternationalPhoneInput/widgets/selector_button.dart';
import 'package:demoapp/UI/commons/InternationalPhoneInput/utils/formatter/as_you_type_formatter.dart';
...
import 'package:demoapp/UI/commons/InternationalPhoneInput/utils/widget_view.dart';
...
class _InputWidgetState extends State<InternationalPhoneNumberInput> {
  ...
  void didUpdateWidget(InternationalPhoneNumberInput oldWidget) {
    ...
    if (oldWidget.initialValue?.hash != widget.initialValue?.hash) {
      if (country!.countryCode != widget.initialValue?.isoCode) {
        loadCountries();
      }
      initialiseWidget();
    }
  ...
  void phoneNumberControllerListener() {
    if (mounted) {
      ...
      getParsedPhoneNumber(parsedPhoneNumberString, country?.countryCode)
          .then((phoneNumber) {
        if (phoneNumber == null) {
          String phoneNumber =
              '${country?.phoneCode}$parsedPhoneNumberString';
...
class _InputWidgetView
  ...
  Widget build(BuildContext context) {
    ...
    final dialCode = state.country?.phoneCode ?? '';
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintText: widget.hintText,
        prefixIcon: SizedBox(
          width: state.country != null ? (state.country!.phoneCode!.length == 2 ? 115 : state.country!.phoneCode!.length == 3 ? 110 : state.country!.phoneCode!.length == 4 ? 120 : 130) : 140,
